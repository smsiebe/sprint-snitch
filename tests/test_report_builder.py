...
def test_build_single_repo():
    builder = ReportBuilder(datetime(2025, 1, 1), datetime(2025, 1, 14))
    am = AuthorMetrics(name="Alice", email="a@e.com", lines_added=30)
...
def test_merge_contributors_different_emails():
    am1 = AuthorMetrics(name="Alice", email="a@e.com", lines_added=30)
    am2 = AuthorMetrics(name="Bob", email="b@e.com", lines_added=20)
